...
async function test() {
  ...
  try {
    ...
    await wait(3000);
    console.log('   页面打开成功');
    await page.screenshot({ path: path.join(__dirname, 'xinfadi-basic-1.png') });
    ...
    fs.writeFileSync(
      path.join(__dirname, 'xinfadi-basic-result.json'),
    ...
    await page.screenshot({ path: path.join(__dirname, 'xinfadi-basic-2.png') });
